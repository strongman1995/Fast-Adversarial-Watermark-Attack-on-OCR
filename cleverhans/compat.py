...
def reduce_function(op_func, input_tensor, axis=None, keep_dims=None,
  ...
  :param keep_dims: If true, retains reduced dimensions with length 1.
  ...
  out = op_func(input_tensor, axis=axis, keep_dims=keep_dims, name=name, reduction_indices=reduction_indices)
